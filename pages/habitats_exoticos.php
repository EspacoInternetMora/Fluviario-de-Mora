...
<div id="content">
    ...
    <div class="especie">
        <img src="../imagens/exposicao/pirapitinga.jpg">
        <div class="descEspecie">
            <h3>Pirapitinga</h3>
            <small><em>Piaractus brachypomus (Cuvier, 1818)</em></small>
    ...
    <div class="especie">
        <img src="../imagens/exposicao/piranha_vermelha.jpg">
        <div class="descEspecie">
            <h3>Piranha-vermelha</h3>
            <small><em>Pygocentrus nattereri (Kner, 1858)</em></small>
            <p><strong>Estatuto de Conservação:</strong> s/avaliação pela IUCN</p>
            <p>
    ...
    <div class="especie">
        <img src="../imagens/exposicao/ciclideo_africano.jpg">
        <div class="descEspecie">
            <h3>Ciclideos-africanos</h3>
            <small><em>Cichlidae (Bonaparte, 1840)</em></small>
            <p><strong>Estatuto de Conservação:</strong> Algumas espécies com estatuto pouco preocupante ou vulnerável</p>
            <p>
